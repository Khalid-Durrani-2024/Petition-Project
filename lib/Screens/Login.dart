...
List<String> _users = ['یوزر نوع انتخاب کړی', 'وزارت', 'پوهنتون', 'پوهنځی'];
bool isHover = false;
                  ...
                  InkWell(
                      onTap: () async {
                        if (_formKey.currentState!.validate()) {
                          await AuthData().authentication(emailController.text,
                              passwordController.text, _selectedType);
...
class _SimpleLogInState extends State<SimpleLogIn> {
  ...
  Widget build(BuildContext context) {
    return Container(
      alignment: Alignment.center,
      decoration: BoxDecoration(
          borderRadius: BorderRadius.circular(22), color: colors.buttonColor),
